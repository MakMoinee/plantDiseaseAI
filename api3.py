...
parser = argparse.ArgumentParser(description="YOLOv5 Flask Streaming App")
parser.add_argument("--ip", type=str, required=True, help="ESP32 camera IP (e.g., [http://192.168.1.5:4747](http://192.168.1.5:4747))")
